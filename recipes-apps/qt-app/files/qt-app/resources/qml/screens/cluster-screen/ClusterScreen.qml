		...
		ColumnLayout {
			...
			Item {
				...
				Item {
					...
					// O multiplicador 400 anterior era demasiado forte para o novo demo, ajustei para 250
				...
				RowLayout {
					...
					Item {
						...
						Image {
							...
							transform: [
								Translate {
									// O multiplicador antigo era -250. Agora que o C++ gera 120px de desvio, o carro sai do ecrã!
									// Ajustado para -1.5 (um erro de 100px no Stanley = 150px no ecrã)
									x: (root.vehicleDataAvailable && vehicleData.laneOffset !== undefined) ? (vehicleData.laneOffset * -1.5 * root.sx) : 0
