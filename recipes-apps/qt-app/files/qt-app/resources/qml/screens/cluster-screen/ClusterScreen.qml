    ...
    Item {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                // =========================================================
                // ROAD CONTAINER: Deslocamento Lateral e Curvatura 3D
                // =========================================================
                Item {
                    id: roadContainer
                    anchors.horizontalCenter: parent.horizontalCenter

                    // DESLOCAMENTO LATERAL (O carro fica fixo, a estrada mexe-se debaixo dele)
                    ...
                    anchors.horizontalCenterOffset: currentLateralOffset
                    ...
                    // CURVATURA (Desloca os pontos do topo das linhas da estrada)
                    property real currentCurveOffset: (root.vehicleDataAvailable && vehicleData.laneHeading !== undefined) ? (vehicleData.laneHeading * -250 * root.sx) : 0

                    // Interpoladores para garantir os 60 FPS
                    ...
                    Image {
                        ...
                        // O tapete base deforma ligeiramente com a curva para dar ilusão 3D
                        transform: Rotation {
                ...
                RowLayout {
                    ...
                    Item {
                        ...
                        Image {
                            ...
                            transform: [
                                Translate {
                                    // Removida a translação X - o carro agora não sai do centro.
                                    // Mantém apenas a simulação de trepidação/bouncing do motor no eixo Y
